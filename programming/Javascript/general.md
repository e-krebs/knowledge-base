[structured clone](https://developer.mozilla.org/en-US/docs/Web/API/Window/structuredClone)
...
[devalue: JSON.stringify on steroids](https://github.com/sveltejs/devalue)
...
[data structures (Map, Set, Stack, Queue, Tree)](https://dev.to/jkettmann/data-structures-in-frontend-javascript-in-the-real-world-with-react-code-examples-3506)
...
[SnapDOM - capture HTML to image](https://snapdom.dev/)
...
[react spectrum - @internationalized/date](https://react-aria.adobe.com/internationalized/date/)
