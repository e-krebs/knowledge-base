...
📝 [[bézier curves]]
[interactive SVG reference](https://fffuel.co/sssvg/) — walks through every svg element and attribute using editable live code
...
[svg maker](https://svg.wtf) — built by amelia wattenberger, with live gui-to-code editing and pinned snapshots
[svg filter maker](https://svgfm.chriskirknielsen.com/) — drag-and-drop node editor lets you chain filter primitives and preview results
...
[svg logos](https://svgl.app/) — curates 669 logos across 50+ categories with an api and shadcn ui support
[shapes](https://www.shapes.gallery/) — offers 70+ copy-paste svgs as one downloadable zip, built in framer
